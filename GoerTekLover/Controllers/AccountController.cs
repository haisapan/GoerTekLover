...
namespace GoerTekLover.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                if (Roles.IsUserInRole(model.UserName, Role.User.ToString()))
                {
                    //TODO 根据角色不同进入不同界面或者功能
                }
        ...
        [AllowAnonymous]
        public ActionResult RegisterConfirmation(string confirmToken)
        {
            if (WebSecurity.ConfirmAccount(confirmToken))
            {
        ...
        //     var confirmationToken=Request["confirmation"];
        //    if (!String.IsNullOrEmpty(confirmationToken))
        //    {
        //        if (WebSecurity.ConfirmAccount(confirmationToken))
        //        {
        //            string message = "Your account has been confirmed. Thanks!";
        //        }
        //        else
        //        {
        //            bool confirmationError = true;
        //            string message = "There was problem while confirming your account.";
        //        }
        //    }

        //    //TODO 添加三秒后转到首页的功能，并添加一个手动链接
        //    return RedirectToAction("Index", "Home"); ;
        //}


        public bool SendConfirmEmail(UserProfile user)
        {
            var entity = new GoerLoverEntities();
            var membership = entity.webpages_Membership.SingleOrDefault(p => p.UserId == user.UserId);
            if (membership != null)
            {
                ...
                if (Request.Url != null)
                {
                    ...
                    email.ConfirmToken = membership.ConfirmationToken;
                    email.BaseUrl = Request.Url.AbsoluteUri;
                    email.Send();
                    return true;
                }
